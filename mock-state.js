...
const mockState = {
  ...
  smeUsers: new Map([
    ...
    ['ajeet.mohan@startup.co.za', {
      userId: 'usr_am006',
      fullName: 'Ajeet Mohan',
      email: 'ajeet.mohan@startup.co.za',
      password: 'User@1234',
      role: 'sme',
      portal: 'sme',
      plan: 'free',
      status: 'Active',
      joinedAt: '2026-06-15',
      companyName: 'Ajeet Mohan Solutions (Pty) Ltd',
      legalName: 'Ajeet Mohan Solutions (Pty) Ltd',
      registrationNumber: '2026/200006/07',
      phone: '',
      physicalAddress: '',
      contactPerson: 'Ajeet Mohan',
      updatedAt: '2026-06-15T08:00:00Z',
    }],
    ['nimish.chauhan@startup.co.za', {
      userId: 'usr_nc007',
      fullName: 'Nimish Chauhan',
      email: 'nimish.chauhan@startup.co.za',
      password: 'User@1234',
      role: 'sme',
      portal: 'sme',
      plan: 'free',
      status: 'Active',
      joinedAt: '2026-06-15',
      companyName: 'Nimish Chauhan Consulting (Pty) Ltd',
      legalName: 'Nimish Chauhan Consulting (Pty) Ltd',
      registrationNumber: '2026/200007/07',
      phone: '',
      physicalAddress: '',
      contactPerson: 'Nimish Chauhan',
      updatedAt: '2026-06-15T08:00:00Z',
    }],
